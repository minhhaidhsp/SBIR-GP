...
namespace SBIR
{
    public class Ontology
    {
        ...
        public Ontology(string FileOntoInit)
        {
        ...
        public Ontology(Notation3Parser parser, Graph graph, Notation3Writer writer)
        {
            this.parser = parser;
            this.graph = graph;
            this.writer = writer;
        ...
        public Ontology()
        {
            this.parser = new Notation3Parser();
            this.graph = new Graph();
            this.writer = new Notation3Writer();
        }
        ...
        public void CreateOntoClass(string FileClass)
        {
            ...
            graph.NamespaceMap.AddNamespace("sbir", new Uri("http://sbir-hcm.vn/"));
        ...
        //public List<List<string>> QueryListSPARQL(string SPARLQL)
        //{
        ...
        //        for (int i = 0; i < len; i++)
        //        {
        //            SparqlResult result = resultSet[i].ToList();
        //            LResult.Add(resultSet[i].ToList());
        //        }
        //    }
        //    return LResult;
        //}
