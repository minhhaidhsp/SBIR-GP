...
namespace SBIR
{
    public class OntologyListViewSBIR
    {
        ...
        public OntologyListViewSBIR(string FileOntoInit)
        {
        ...
        public OntologyListViewSBIR(Notation3Parser parser, Graph graph, Notation3Writer writer)
        {
            this.parser = parser;
            this.graph = graph;
            this.writer = writer;
